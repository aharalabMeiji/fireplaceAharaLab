...
def main():
	...
	import time
	s_time=time.time()
	a,b,c = play_set_of_games(Vector1, Vector2, deck1=BigDeck.faceHunter, deck2=BigDeck.faceHunter, gameNumber=100, debugLog=True)
...
if __name__ == "__main__":
	#from card_test.alterac_druid import SimulateGames_Alterac_Druid
