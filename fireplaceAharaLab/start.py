...
def main():
	...
	Human1=HumanAgent("Human1",HumanAgent.HumanInput,myClass=CardClass.PALADIN,
	...
	a,b,c = play_set_of_games(Human1, Human2, deck1=BigDeck.testPaladin, deck2=BigDeck.faceHunter, gameNumber=15, debugLog=True)
