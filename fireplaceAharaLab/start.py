...
def printClasses():
	...
	myClassText="DemonHunter"##DemonHunter,Druid,Hunter,Mage,Neutral,Paladin,Priest,Rogue,Shaman,Warlock,Warrior
...
def card_test():
	from card_test.sunken_neutral import sunken_neutral
	sunken_neutral()
	pass
