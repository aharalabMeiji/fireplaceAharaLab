...
def core_druid():
	## 23.6
	#PresetGame(pp_CORE_AT_037a)##OK
	#PresetGame(pp_CORE_AT_037b)##OK
	#PresetGame(pp_CORE_AT_037ab)##OK
	#PresetGame(pp_CORE_CS2_009)##OK
	#PresetGame(pp_CORE_CS2_013)##OK
	#PresetGame(pp_CORE_EX1_154a)##OK
	#PresetGame(pp_CORE_EX1_154b)##OK
	#PresetGame(pp_CORE_EX1_154ab)##OK
	#PresetGame(pp_CORE_EX1_158)##OK
	#PresetGame(pp_CORE_EX1_160a)##OK
	#PresetGame(pp_CORE_EX1_160b)##OK
	#PresetGame(pp_CORE_EX1_160ab)##OK
	#PresetGame(pp_CORE_EX1_164a)##OK
	#PresetGame(pp_CORE_EX1_164b)##OK
	#PresetGame(pp_CORE_EX1_164ab)##OK
	#PresetGame(pp_CORE_EX1_165a)##OK
	#PresetGame(pp_CORE_EX1_165b)##OK
	#PresetGame(pp_CORE_EX1_165ab)##OK
	#PresetGame(pp_CORE_EX1_169)##OK
	#PresetGame(pp_CORE_EX1_571)##OK
	#PresetGame(pp_CORE_EX1_573a)##OK
	#PresetGame(pp_CORE_EX1_573b)##OK
	#PresetGame(pp_CORE_EX1_573ab)##OK
	#PresetGame(pp_CORE_LOE_050)##OK
	#PresetGame(pp_CORE_NEW1_008a)##OK
	#PresetGame(pp_CORE_NEW1_008b)##OK
	#PresetGame(pp_CORE_NEW1_008ab)##OK
	#PresetGame(pp_CORE_OG_044)##OK
	#PresetGame(pp_CORE_OG_047a)##OK
	#PresetGame(pp_CORE_OG_047b)##OK
	#PresetGame(pp_CORE_OG_047ab)##OK
	PresetGame(pp_CORE_TRL_243)##OK
	PresetGame(pp_CORE_UNG_108)##OK
	PresetGame(pp_CS3_012x)##OK
	PresetGame(pp_CS3_012y)##OK
	## 22.6
##############CORE_AT_037###################
