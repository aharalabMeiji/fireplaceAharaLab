...
class DRG_070:#OK
	"""Dragon Breeder	Rare
	[Battlecry:] Choose a friendly Dragon. Add a copy of it to_your hand."""
...
class DRG_257:#OK
	...
	[Battlecry:] Reduce the Cost of Dragons in your deck by_(2)."""
...
class DRG_074:#OK
	...
	[Battlecry:] Give your other Mechs [Stealth] until your_next turn."""
...
class DRG_402:#OK
	...
	[Battlecry:] Choose a friendly minion. Add a copy of it to_your hand, deck, and battlefield."""
	requirements = {
		PlayReq.REQ_MINION_TARGET: 0,
