...
class DAL_546:#OK
	...
	[Battlecry:] Add a copy of each of your other [Battlecry] minions_to_your_hand."""
...
class DAL_751:#OK
	...
	[x][Battlecry:] Fill each player's
	board with 1/1 Imps."""
	def play(self):
...
class DAL_554:# no way to check!
	...
	[Battlecry:] If your deck is empty, summon six 6/6 Greasefire_Elementals."""
...
class DAL_736:## simulator ##OK
	...
	[Battlecry:] [Discover] 5 cards. Replace your deck with 2_copies of each."""
	def play(self):
		new_deck = []
		for n in range(5):
