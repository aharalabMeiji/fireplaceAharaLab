...
class ULD_184:#OK
	...
	[Deathrattle:] Deal 3 damage to the enemy_hero."""
	deathrattle = Hit(ENEMY_HERO, 3)

class ULD_196:#OK
	"""Neferset Ritualist		2	2	3	Minion	Rare	-	Battlecry
	[Battlecry:] Restore adjacent minions to full_Health."""
...
class ULD_197:#OK
	...
	[Battlecry:] Give all enemy minions -2 Attack this_turn."""
...
class ULD_250:#OK
	...
	[Taunt]
	[Deathrattle:] Add two 1/1 Scarabs with [Taunt] to your hand."""
	deathrattle = Give(CONTROLLER, "ULD_215t")*2

class ULD_229:#OK
	"""Mischief Maker		3	3	3	Minion	Epic	-	Battlecry
	[Battlecry:] Swap the top card of your deck with your_opponent's."""
	def play(self):
...
class ULD_178:# OK for once ##################  ( how we do twice? )
	...
	[x][Battlecry:] Gain 2 of [Rush],
	[Taunt], [Divine Shield], or
	[Windfury] <i>(your choice).</i>"""
