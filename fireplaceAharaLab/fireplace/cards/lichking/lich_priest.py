...
if Lich_Crystalsmith_Cultist:# 
	Lich_Priest+=['RLK_814']
class RLK_814_Action(GameAction):# 
	def do(self, source):# 
		controller=source.controller
		pass
...
class RLK_814e_Action(GameAction):# 
	def do(self, source):# 
		controller=source.controller
		pass
class RLK_814e:# <6>[1776]
	""" Shadow Flow (0)
	+1/+1 """
	#
	pass
...
if Lich_Sister_Svalna:# 
	Lich_Priest+=['RLK_816']
class RLK_816_Action(GameAction):# 
	def do(self, source):# 
		controller=source.controller
		pass
...
class RLK_816t3_Action(GameAction):# 
	def do(self, source):# 
		controller=source.controller
		pass
...
class RLK_822e_Action(GameAction):# 
	def do(self, source):# 
		controller=source.controller
		pass
...
class RLK_822e2_Action(GameAction):# 
	def do(self, source):# 
		controller=source.controller
		pass
...
class RLK_822t_Action(GameAction):# 
	def do(self, source):# 
		controller=source.controller
		pass
