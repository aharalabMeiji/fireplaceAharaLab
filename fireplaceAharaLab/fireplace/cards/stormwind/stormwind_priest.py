...
StormWind_Priest=[]
StormWind_For_the_Alliance!=True
StormWind_Holy_Empowerment=True
StormWind_Xyrella=True
StormWind_Shadow_Priest_Xyrella=True
StormWind_Naarus_Light=True
StormWind_Mind_Spike=True
StormWind_Xyrella=True
StormWind_Amulet_of_Undying=True
StormWind_Defias_Leper=True
StormWind_Copycat=True
StormWind_Tyrande_Whisperwind=True
StormWind_Trapped_Tyrande=True
StormWind_Shadowcloth_Needle=True
StormWind_Seek_Guidance=True
StormWind_Discover_the_Void_Shard=True
StormWind_Illuminate_the_Void=True
StormWind_Xyrella,_the_Sanctified=True
StormWind_Purified_Shard=True
StormWind_Call_of_the_Grave=True
StormWind_Shard_of_the_Naaru=True
StormWind_Void_Shard=True
StormWind_Elekk_Mount=True
StormWind_On_an_Elekk=True
StormWind_Xyrellas_Elekk=True
StormWind_Twilight_Deceptor=True
StormWind_Psyfiend=True
StormWind_Voidtouched_Attendant=True
StormWind_Voidtouched=True
StormWind_Darkbishop_Benedictus=True
if StormWind_For_the_Alliance!:# 
	StormWind_Priest+=['BOM_05_Bolvar_007p']
class BOM_05_Bolvar_007p:# <6>[1578]
	""" For the Alliance!
	[Hero Power]Summon five minions from your deck. Give them +3 Health and [Taunt]. """
	#
	pass

if StormWind_Holy_Empowerment:# 
	StormWind_Priest+=['BOM_05_Xyrella_006e']
class BOM_05_Xyrella_006e:# <6>[1578]
	""" Holy Empowerment
	Costs (2) less. """
	#
	pass

if StormWind_Xyrella:# 
	StormWind_Priest+=['BOM_05_Xyrella_006hb']
class BOM_05_Xyrella_006hb:# <6>[1578]
	""" Xyrella
	Xyrella sought knowledgeof the naaru's power, butfound Tamsin at StormwindCathedral instead. """
	#
	pass

if StormWind_Shadow_Priest_Xyrella:# 
	StormWind_Priest+=['BOM_05_Xyrella_006hb2']
class BOM_05_Xyrella_006hb2:# <6>[1578]
	""" Shadow Priest Xyrella
	 """
	#
	pass

if StormWind_Naarus_Light:# 
	StormWind_Priest+=['BOM_05_Xyrella_006p']
class BOM_05_Xyrella_006p:# <6>[1578]
	""" Naaru's Light
	[Passive Hero Power]Your Holy Spellscost (2) less. """
	#
	pass

if StormWind_Mind_Spike:# 
	StormWind_Priest+=['BOM_05_Xyrella_006p2']
class BOM_05_Xyrella_006p2:# <6>[1578]
	""" Mind Spike
...
if StormWind_Xyrella:# 
	StormWind_Priest+=['BOM_07_Scabbs_Xyrella_008t']
class BOM_07_Scabbs_Xyrella_008t:# <6>[1578]
	""" Xyrella
...
if StormWind_Tyrande_Whisperwind:# 
	StormWind_Priest+=['Story_10_Tyrande']
class Story_10_Tyrande:# <6>[1578]
	""" Tyrande Whisperwind
	 """
	#
	pass

if StormWind_Trapped_Tyrande:# 
	StormWind_Priest+=['Story_10_TyrandeTrapped']
class Story_10_TyrandeTrapped:# <6>[1578]
	""" Trapped Tyrande
	[Dormant]Defeat Velas to free Tyrande. """
	#
	pass
...
if StormWind_Discover_the_Void_Shard:# 
...
if StormWind_Illuminate_the_Void:# 
...
if StormWind_Xyrella,_the_Sanctified:# 
