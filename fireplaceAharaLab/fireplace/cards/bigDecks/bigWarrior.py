...
#'BT_781',
#'DMF_522','DMF_522',
#'CORE_EX1_407','CORE_EX1_407',
#'CORE_EX1_410','CORE_EX1_410',
#'SCH_237','SCH_237',
#'SCH_337','SCH_337',
#'SCH_533','SCH_533',
#'SCH_621',
...
class DMF_522:###OK
	...
	play = SplitHit(CONTROLLER, ALL_MINIONS, 5)
	pass



BigWarrior+=['CORE_EX1_407']
...
#		Destroy(ALL_MINIONS - RANDOM_MINION)#it may be enough if we use this line
#	)
#	pass



BigWarrior+=['CORE_EX1_410']
...
BigWarrior+=['SCH_621']
class SCH_621_Action(GameAction):
	def do(self, source):
		if hasattr(source, 'atk') and hasattr(source, 'max_health'):
			new_atk = source.atk - 1
			new_health = source.max_health - 1
			new_minion = Summon(source.controller, source.id).trigger(source.controller)
			new_minion = get00(new_minion)
