...
class Config(IntEnum):# ()is the default value
    FSFIXED=1 # fixing first and second (先攻と後攻を固定) YES:>0 NO:0(0) 
    COIN=0.5 # giving a coin to the second (後攻にコインを与えるか) YES:>0 NO:0(1)
    EX_CARD=0.5 # giving an extra ard to the second (後攻にカードを与えるか) YES:>0 NO:0(1)
